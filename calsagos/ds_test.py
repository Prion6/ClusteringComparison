...
def calc_delta_DS(RA, DEC, peculiar_velocity, redshift_member, sigma_cluster):

    """ calsagos.dressler_schectman_test.calc_delta_DS(RA, DEC, peculiar_velocity, redshift_member, sigma_cluster)

	Function that computes the delta_i value 
    defined by the Dressler-Schectman Test 
    (see Dressler & Shectman, 1988)

    This function was developed by D. E. Olave-Rojas
    ...
    :param sigma_cluster: velocity dispersion of
        the cluster
    ...
    calc_delta_DS(RA, DEC, peculiar_velocity, redshift_member, sigma_cluster)[0] corresponds to the 
        delta_i value for each galaxy by Dressler & Shectman, (1988)
    calc_delta_DS(RA, DEC, peculiar_velocity, redshift_member, sigma_cluster)[1] corresponds to the
        critical value definen by Dressler & Shectman, (1988)
    calc_delta_DS(RA, DEC, peculiar_velocity, redshift_member, sigma_cluster)[2] corresponds to the
